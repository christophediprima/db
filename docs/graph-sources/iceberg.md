...
fluree iceberg map silver-actor \
  --mode direct \
  --table-location s3://my-bucket/iceberg/silver_actor \
  --r2rml mappings/silver_actor.ttl \
...
```json
{
  "name": "silver-actor",
  "mode": "direct",
  "table_location": "s3://my-bucket/iceberg/silver_actor",
  "r2rml": "...",
  "r2rml_type": "text/turtle",
